...
//===========================Vehicle===========================
  ...
  const updateVehicle = async () => {
    try {
      const token = localStorage.getItem("token");
      const res = await fetch(`https://smartcity-backend-try1-301261782088.asia-south1.run.app/vehicles/${selectedVehicleId}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
...
const createVehicle = async () => {
    try {
      ...
      const res = await fetch(`https://smartcity-backend-try1-301261782088.asia-south1.run.app/vehicles/`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
