...
//===========================Profile===========================
  ...
  const getProfile = async () => {
    try {
      ...
      const res = await fetch('http://http://localhost:8080/humans/', {
        headers: {
...
const bookVehicle = async (vehicleId) => {
  try {
    const token = localStorage.getItem("token");
    const res = await fetch(`http://http://localhost:8080/vehicles/${vehicleId}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`
...
const toggleVehiclesModal = async () => {
  ...
  try {
    const token = localStorage.getItem("token");
    const res = await fetch("http://http://localhost:8080/vehicles/all", {
...
//===========================Incident===========================
  ...
  const deleteIncident = async (incidentId) => {
    try {
      ...
      const response = await fetch(`http://http://localhost:8080/incident/${incidentId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
        },
...
const createIncident = async () => {
    try {
      ...
      const response = await fetch('http://http://localhost:8080/incident/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
...
const fetchIncidentData = async () => {    
    try {
      const token = localStorage.getItem("token");
      const res = await fetch("http://http://localhost:8080/incident/all", {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${token}`,
        }
...
//===========================Maintenance===========================
  ...
  const updateMaintenance = async () => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`http://http://localhost:8080/maintenance/${editingMaintenanceId}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
  ...
  const deleteMaintenance = async (maintenanceId) => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`http://http://localhost:8080/maintenance/${maintenanceId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
        },
  ...
  const fetchMaintenanceData = async () => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch('http://http://localhost:8080/maintenance/', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
...
//===========================Maintenance History===========================
  ...
  const fetchMaintenanceHistory = async () => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch('http://http://localhost:8080/maintenance-history/', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
  ...
  const deleteMaintenanceHistory = async (m_id, v_id) => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`http://http://localhost:8080/maintenance-history/${m_id}/${v_id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
        },
...
//===========================Accident History===========================
  ...
  const fetchAccidentHistory = async () => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch('http://http://localhost:8080/accident-history/', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
...
//===========================Operates on===========================
  ...
  try {
    const token = localStorage.getItem('token');
    const response = await fetch('http://http://localhost:8080/operates_on/', {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`,
...
const deleteOperatesOn = async (v_id, s_id) => {
  try {
    const token = localStorage.getItem('token');
    const response = await fetch(`http://http://localhost:8080/operates_on/${v_id}/${s_id}`, {
      method: 'DELETE',
      headers: {
        'Authorization': `Bearer ${token}`,
      },
...
//===========================Payment===========================
  ...
  const fetchPayments = async () => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch('http://http://localhost:8080/payments/', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
...
const deletePayment = async (payment_id) => {
  try {
    const token = localStorage.getItem('token');
    const response = await fetch(`http://http://localhost:8080/payments/${payment_id}`, {
      method: 'DELETE',
      headers: {
        'Authorization': `Bearer ${token}`,
      },
...
//===========================Performs Maintenance===========================
  ...
  const fetchPerformsMaintenance = async () => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch('http://http://localhost:8080/performs-maintenance/', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
  ...
  const deletePerformsMaintenance = async (m_id, staff_id) => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`http://http://localhost:8080/performs-maintenance/${m_id}/${staff_id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
        },
...
//===========================Route===========================
  ...
  const createRoute = async () => {
    try {
      const token = localStorage.getItem("token");
      const response = await fetch(`http://http://localhost:8080/routes/${routeId}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
...
//===========================Route Followed===========================
  ...
  const createRouteFollowed = async () => {
    try {
      ...
      const res = await fetch("http://http://localhost:8080/route-followed/", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const deleteRouteFollowed = async (routeId) => {
    try {
      ...
      const res = await fetch(`http://http://localhost:8080/route-followed/${routeId}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
//===========================Schedule Followed===========================
  ...
  const fetchScheduleFollowed = async () => {
    try {
      ...
      const res = await fetch("http://http://localhost:8080/schedule-followed/", {
        headers: { Authorization: `Bearer ${token}` },
      });
...
//===========================Schedule===========================
  ...
  const fetchSchedule = async () => {
    try {
      const token = localStorage.getItem("token");
      const res = await fetch("http://http://localhost:8080/schedule/", {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const deleteSchedule = async (scheduleId) => {
    try {
      const token = localStorage.getItem("token");
      const res = await fetch(`http://http://localhost:8080/schedule/${scheduleId}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const createOrUpdateSchedule = async () => {
    ...
    try {
      ...
      const url = isUpdate
        ? `http://http://localhost:8080/schedule/${body.schedule_id}`
        : `http://http://localhost:8080/schedule/`;
...
const logout = async () => {
  try {
    const token = localStorage.getItem('token');
    await fetch('http://http://localhost:8080/auth/logout', {
      method: 'POST',
      headers: {
        'Authorization': `Bearer ${token}`,
      },
...
return (
  ...
  <h1 className="text-4xl font-semibold text-center text-gray-800 dark:text-white mb-12">
    ...
    <h2>Welcome Incident Manager</h2>
