...
//===========================Schedule Followed===========================
  ...
  const fetchScheduleFollowed = async () => {
    try {
      ...
      const res = await fetch("https://smartcity-backend-try1-301261782088.asia-south1.run.app/schedule-followed/all", {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const createScheduleFollowed = async () => {
    try {
      ...
      const res = await fetch(
        `https://smartcity-backend-try1-301261782088.asia-south1.run.app/schedule-followed/${newScheduleRId}/${newScheduleSId}`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const deleteScheduleFollowed = async (s_id) => {
    try {
      ...
      const res = await fetch(`https://smartcity-backend-try1-301261782088.asia-south1.run.app/schedule-followed/${s_id}`, {
        method: "DELETE",
        headers: { Authorization: `Bearer ${token}` },
      });
...
//===========================Schedule===========================
  ...
  const fetchSchedule = async () => {
    try {
      const token = localStorage.getItem("token");
      const res = await fetch("https://smartcity-backend-try1-301261782088.asia-south1.run.app/schedule/all", {
        headers: { Authorization: `Bearer ${token}` },
      });
...
return (
  ...
  <h1 className="text-4xl font-semibold text-center text-gray-800 dark:text-white mb-12">
    ...
    <h2>Welcome Schedule Manager</h2>
