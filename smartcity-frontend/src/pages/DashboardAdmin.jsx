...
const fetchScheduleFollowed = async () => {
  try {
    ...
    const res = await fetch("http://localhost:8080/schedule-followed/all", {
      headers: { Authorization: `Bearer ${token}` },
    });
...
const createScheduleFollowed = async () => {
  try {
    ...
    const res = await fetch(
      `http://localhost:8080/schedule-followed/${newScheduleRId}/${newScheduleSId}`,
      {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
...
const deleteScheduleFollowed = async (s_id) => {
  try {
    ...
    const res = await fetch(`http://localhost:8080/schedule-followed/${s_id}`, {
      method: "DELETE",
      headers: { Authorization: `Bearer ${token}` },
    });
...
const createRouteFollowed = async () => {
  try {
    ...
    const res = await fetch(
      `http://localhost:8080/route-followed/${parseInt(newRouteFollowedId)}/${parseInt(newRouteFollowedVehicleId)}`,
      {
        method: "POST",
        headers: {
          "Authorization": `Bearer ${token}`,
...
const deleteRouteFollowed = async (routeId,vid) => {
  try {
    ...
    const res = await fetch(`http://localhost:8080/route-followed/${routeId}/${vid}`, {
      method: "DELETE",
      headers: {
        Authorization: `Bearer ${token}`,
      },
...
const fetchRouteFollowed = async () => {
  try {
    ...
    const res = await fetch("http://localhost:8080/route-followed/all", {
      headers: { Authorization: `Bearer ${token}` },
    });
...
const fetchPerformsMaintenance = async () => {
  try {
    const token = localStorage.getItem('token');
    const response = await fetch('http://localhost:8080/performs-maintenance/all', {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`,
...
const createPayment = async () => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`http://localhost:8080/payments/${newPassengerId}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
...
const fetchOperatesOn = async () => {
  try {
    const token = localStorage.getItem('token');
    const response = await fetch('http://localhost:8080/operates_on/all', {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`,
...
const fetchMaintenanceHistory = async () => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch('http://localhost:8080/maintenance-history/all', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
...
const fetchMaintenanceData = async () => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch('http://localhost:8080/maintenance/all', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
...
const fetchSingleMaintenance = async (maintenanceId) => {
    try {
      const token = localStorage.getItem('token');
      const res = await fetch(`http://localhost:8080/maintenance/${maintenanceId}`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${token}`
        }
...
const fetchAccidentHistory = async () => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch('http://localhost:8080/accident-history/all', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
...
const updateAccidentHistory = async () => {
  try {
    ...
    const response = await fetch(`http://localhost:8080/accident-history/${oldVID}/${oldIID}?old_vid=${oldVID}&old_iid=${oldIID}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`,
...
const fetchIncidentData = async () => {    
    try {
      const token = localStorage.getItem("token");
      const res = await fetch("http://localhost:8080/incident/all", {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${token}`,
        }
...
const getProfile = async () => {
    try {
      const token = localStorage.getItem("token");
      const res = await fetch('http://localhost:8080/humans/all', {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
