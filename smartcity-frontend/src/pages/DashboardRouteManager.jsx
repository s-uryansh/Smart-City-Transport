...
//===========================Route Followed===========================
  ...
  const createRouteFollowed = async () => {
    try {
      ...
      const res = await fetch(
        `https://smartcity-backend-try1-301261782088.asia-south1.run.app/route-followed/${parseInt(newRouteFollowedId)}/${parseInt(newRouteFollowedVehicleId)}`,
        {
          method: "POST",
          headers: {
            "Authorization": `Bearer ${token}`,
  ...
  const deleteRouteFollowed = async (routeId,vid) => {
    try {
      ...
      const res = await fetch(`https://smartcity-backend-try1-301261782088.asia-south1.run.app/route-followed/${routeId}/${vid}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const fetchRouteFollowed = async () => {
    try {
      ...
      const res = await fetch("https://smartcity-backend-try1-301261782088.asia-south1.run.app/route-followed/all", {
        headers: { Authorization: `Bearer ${token}` },
      });
